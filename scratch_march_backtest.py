...
# Definisikan periode mingguan sepanjang bulan Maret 2026 (Senin - Jumat)
weeks = [
    {"name": "Minggu 1 (2 - 6 Mar)", "to": "2026-03-06", "range": 2500},
    {"name": "Minggu 2 (9 - 13 Mar)", "to": "2026-03-13", "range": 2500},
    {"name": "Minggu 3 (16 - 20 Mar)", "to": "2026-03-20", "range": 2500},
    {"name": "Minggu 4 (23 - 27 Mar)", "to": "2026-03-27", "range": 2500},
    {"name": "Minggu 5 (30 Mar - 3 Apr)", "to": "2026-04-03", "range": 2500}
]

print("MEMULAI PENGUJIAN MINGGUAN BULAN MARET 2026 (TIMEFRAME 5M, SALDO $40)...\n")
...
for w in weeks:
    ...
    # Menjalankan bot.py dengan timeframe 5M (default bot.py adalah 5M jika tidak diubah di main CLI)
    ...
    try:
        ...
        # Cetak output error jika ada masalah pengambilan data
        print("Output:", res.stdout[:500])

# Cetak tabel laporan akhir
print("\n==========================================================================================")
print("📋 LAPORAN KINERJA MINGGUAN BULAN MARET 2026 (5M, $40 Capital, Lot 0.01, Daily Loss $10)")
print("==========================================================================================")
